...
export default function Header() {
  return (
    <div className='bg-[#161e31] text-white h-12 mt-3 border-t-2 border-b-2 border-[#597199] flex'>
        <div className='w-14 flex-auto mt-2 ml-2'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
...
<div className='w-64 flex-auto text-2xl mt-1 font-bold'>Bomb Detection Application</div>

<div className='w-25 flex-end text-green-600 mt-2 mr-5 '>Simulation Active</div>
